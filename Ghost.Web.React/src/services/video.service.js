...
export const fetchVideos = async (page, limit, search, sortBy, ascending, watched) => {
  const videosResult = await axios.get(
    `media?${constructVideoParams({ page, limit, search, sortBy, ascending, watched })}`,
  )
